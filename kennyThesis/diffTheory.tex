\chapter{Photo-nuclear interactions \label{ch:photoNuc}}
    ...
    \DIFdelbegin \DIFdel{It is impossible to create the QGP in UPC events because the nucleons 
      within the nucleus }\DIFdelend \DIFaddbegin \DIFadd{In UPC events the nuclei }\DIFaddend do not collide\DIFaddbegin \DIFadd{, therefore final state effects coming
      from the QGP are not expected}\DIFaddend . 
...
\DIFdelend The convolution of the photon flux with the $b$-dependent probability that 
    ...
    The \DIFdelbegin \DIFdel{average photon flux }\DIFdelend \DIFaddbegin \DIFadd{photon flux is averaged }\DIFaddend over impact parameter \DIFdelbegin \DIFdel{can be calculated 
      ...
      $b$-dependent photon flux \DIFdelbegin \DIFdel{with }\DIFdelend \DIFaddbegin \DIFadd{multiplied by }\DIFaddend the $b$-dependent probability of having no 
    ...
    \DIFaddbegin \DIFadd{Due to this consideration, vector meson dominance asserts that only the 
