\chapter{\label{ch:detector} The Compact Muon Solenoid detector}	
  ...
  Muon capabilities developed for the Higgs boson studies can be used to study 
    \JPsi{} \DIFaddbegin \DIFadd{production}\DIFaddend . 
  ...
  \section{Tracker}
    ...
    At the center of the tracker are three rings of silicon pixels around the 
      beam \DIFaddbegin \DIFadd{axis }\DIFaddend with two disks of silicon \DIFdelbegin \DIFdel{pixels }\DIFdelend \DIFaddbegin \DIFadd{pixel detectors }\DIFaddend to cap the rings.
    The pixel \DIFaddbegin \DIFadd{detector }\DIFaddend portion of the silicon tracker is comprised of 66$\times$10$^{6}$
    	pixels.
    The silicon \DIFdelbegin \DIFdel{pixels }\DIFdelend \DIFaddbegin \DIFadd{pixel detectors }\DIFaddend are surrounded by silicon strips.
  ...
  \section{ZDC \label{sec:zdcDet}} 
    ...
    These measurements are used to identify events with asymmetric neutron 
      emission, reducing the contribution to the sample \DIFdelbegin \DIFdel{by }\DIFdelend \DIFaddbegin \DIFadd{of }\DIFaddend peripheral heavy-ion 
      \DIFaddbegin \DIFadd{collisions}\DIFaddend .
  ...
  \section{\label{sec:detTrg}Trigger}
    ...
    The High Level Trigger (HLT) is \DIFdelbegin \DIFdel{a software base }\DIFdelend \DIFaddbegin \DIFadd{software based }\DIFaddend and runs on a computer farm
      located at point 5.
    ...
    Because of this time constraint in the HLT farm, the reconstruction 
      algorithms used for triggering \DIFdelbegin \DIFdel{tended }\DIFdelend \DIFaddbegin \DIFadd{tend }\DIFaddend to differ from the final 
    ...
    The wide \DIFdelbegin \DIFdel{gamete }\DIFdelend \DIFaddbegin \DIFadd{gamut }\DIFaddend of physics topics that are pursued by the CMS collaboration
