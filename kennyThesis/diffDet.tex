\chapter{\label{ch:detector} The Compact Muon Solenoid detector}	
  ...
  This is the scale where electroweak symmetry breaking is believed to occur
  	\cite{CmsPTdrv2}.
  While \DIFdelbegin \DIFdel{this means that }\DIFdelend the search for the standard model Higgs boson was the 
  ...
  \DIFdelbegin \DIFdel{The expedient discovery of new physics through low cross section interactions 
  	requires high luminosity}\DIFdelend \DIFaddbegin \DIFadd{CMS was optimized to make excellent measurements of muons}\DIFaddend . 
  ...
  \DIFdelbegin \DIFdel{The general purpose design of }\DIFdelend CMS is dominated by the massive 4T 
  ...
  \section{Tracker}
    ...
    \DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{A }\DIFaddend radiation length is the mean distance a \DIFdelbegin \DIFdel{high energy particle travels before 
    ...
    }\DIFdelend \DIFaddbegin \DIFadd{photon travels before 
      interacting. 
    }\DIFaddend As opposed to the deflection angle set by the strength of the magnetic 
      field, the momentum resolution for lower momentum tracks is limited by 
      the \DIFdelbegin \DIFdel{lose }\DIFdelend \DIFaddbegin \DIFadd{loss }\DIFaddend of energy due to \DIFaddbegin \DIFadd{multiple }\DIFaddend scattering of these particles off the material 
      of the detector.
  ...
  \section{ECAL}
    ...
    The calorimeter system is made of 61,200 lead tungstate (PbWO$_{4}$) 
      crystals in the central barrel and 7,324 \DIFdelbegin \DIFdel{on }\DIFdelend \DIFaddbegin \DIFadd{in }\DIFaddend each of the two endcaps 
      \cite{tCmsE}.
    ...
    Lead tungstate is very dense giving the ECAL crystals a high number of 
      \DIFdelbegin \DIFdel{interaction }\DIFdelend \DIFaddbegin \DIFadd{radiation }\DIFaddend lengths within a short depth.
    ...
    For \JPsi{} with rapidity near 2, the electron will carry \DIFdelbegin \DIFdel{at least 10 }\DIFdelend \DIFaddbegin \DIFadd{energies around
      6 }\DIFaddend GeV and can be resolved by the ECAL. 
  ...
  \section{HCAL}
    ...
    HE, like EE and the tracker endcaps, is aligned \DIFdelbegin \DIFdel{perpendicular }\DIFdelend \DIFaddbegin \DIFadd{parallel }\DIFaddend to the beam axis
    	resulting in granularity that changes with $\eta$.
    In the region $1.3 <|\eta|< 1.6$ HE has an $\eta-\phi$ segmentation of 
    	$0.0897\times0.0897$.
    The $\eta-\phi$ \DIFdelbegin \DIFdel{segmentation }\DIFdelend \DIFaddbegin \DIFadd{cell size }\DIFaddend roughly doubles to $0.17\times0.17$ in the region
    	$1.6 <|\eta|< 3$.
    ...
    The thickness of the hadronic calorimeter is best described in interaction
    	lengths, \DIFaddbegin \DIFadd{$\lambda_I$, which is }\DIFaddend the mean distance \DIFdelbegin \DIFdel{for a particle to give up an $e$-fold of energy
    	through nuclear interactions}\DIFdelend \DIFaddbegin \DIFadd{a hadron travels before 
       it experiences a nuclear interaction}\DIFaddend .
    ...
    The longitudinal direction is effectively segmented by using both short and
    	long fibers.
    The \DIFdelbegin \DIFdel{energy deposited deeper than }\DIFdelend \DIFaddbegin \DIFadd{long fibers are sensitive to energy deposited throughout the calorimeter, i.e. to both the hadronic and electromagnetic parts of the shower. The short fibers are only sensitive to the energy deposited more than }\DIFaddend 22cm \DIFdelbegin \DIFdel{is measured in both the short
    	and long fibers, where as the long fibers are present throughout}\DIFdelend \DIFaddbegin \DIFadd{inside the calorimeter, which is mainly hadronic}\DIFaddend . 
  ...
  \DIFaddbegin \section{\DIFadd{CASTOR}}
   \DIFadd{Very forward angles are covered at one end of CMS ($6.6 < \eta < 5.2$) by 
     the CASTOR calorimeter \mbox{%DIFAUXCMD
\cite{Andreev:2010zzb}
}%DIFAUXCMD
.
  ...
  \DIFaddend \section{ZDC \label{sec:zdcDet}} 
  ...
  \section{Muons}
    ...
    It consists of three complementary systems: drift tube (DT) \DIFdelbegin \DIFdel{chambers }\DIFdelend in the
    ...
    Each $z$ segment is divided into 12 $\phi$ segments labeled 1 at $\phi$ = 0
      ...
      \DIFdelbegin \DIFdel{contain }\DIFdelend \DIFaddbegin \DIFadd{containing }\DIFaddend 2 chambers.
   ...
   Super layers SL $\Phi_{1}$ and SL $\Phi_{2}$ measure $(r,\phi)$, whereas 
    ...
    \begin{figure*}[!Hhbt]
      \centering
      \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.65\textwidth]{dtStruct} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.85\textwidth]{dtStruct} \DIFaddendFL \\
      \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.65\textwidth]{dtCell}
%DIFDELCMD <       %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.85\textwidth]{dtCell}
      \DIFaddendFL \caption{Schematic of the DT chambers and an individual DT cell.}
      \label{fig:dtSchem}
    \end{figure*}
    ...
    The outer ring of the muon \DIFdelbegin \DIFdel{endcap }\DIFdelend \DIFaddbegin \DIFadd{endcaps }\DIFaddend are instrumented with RPCs covering up to
      $|\eta|$ = 1.6.
    \begin{figure}[!Hhbt]
      \centering
    ...
    There \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{are }\DIFaddend a total of 468 CSC modules in the muon system endcap. 
    For the sectors in $z$, ME2, ME3, and ME4 in the endcap, the modules in 
      the ring closest to the beam \DIFdelbegin \DIFdel{are covering }\DIFdelend \DIFaddbegin \DIFadd{cover }\DIFaddend 20$^{\circ}$ in $\phi$.
    The modules in ME1 and the modules \DIFdelbegin \DIFdel{in beyond in }\DIFdelend \DIFaddbegin \DIFadd{beyond }\DIFaddend the inner ring in
    ...
    The resolution of the CSCs in on the order of 1mm for position measurements 
      in the plane perpendicular to the beam and \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{they are }\DIFaddend 99\% efficient for muons
    ...
    The primary function of the muon systems \DIFdelbegin \DIFdel{are to allow for triggering on and identification of }\DIFdelend \DIFaddbegin \DIFadd{is to trigger on and identify 
      }\DIFaddend muons.
    The tracker is still the primary instrument for measuring the muons. 
    Fig.~\ref{fig:muonRes} shows \DIFdelbegin \DIFdel{the resolution of reconstructed muons with 
      the tracker only is only improved upon }\DIFdelend \DIFaddbegin \DIFadd{that the muon system only improves the 
      momentum resolution }\DIFaddend for muons with momenta above 100 GeV. 
    For UPC \JPsi{}~events, where muons momenta are between \DIFdelbegin \DIFdel{1-2 }\DIFdelend \DIFaddbegin \DIFadd{4-8 }\DIFaddend GeV, the muon
      system does not provide any advantage in terms of improved resolution.
    The muon system is however important in \DIFdelbegin \DIFdel{distiguishing }\DIFdelend \DIFaddbegin \DIFadd{distinguishing }\DIFaddend which tracks are 
      due to muons as opposed to other charged particles.
    Because of their \DIFdelbegin \DIFdel{increase }\DIFdelend \DIFaddbegin \DIFadd{much larger }\DIFaddend mass relative to electrons, muons emit less 
      bremsstralung, or breaking radiation, as \DIFdelbegin \DIFdel{it penetrates }\DIFdelend \DIFaddbegin \DIFadd{they penetrate }\DIFaddend the inner layers
    ...
    The total of nearly 10 interaction lengths between the interaction point 
      ...
      \DIFdelbegin \DIFdel{nearly }\DIFdelend \DIFaddbegin \DIFadd{almost }\DIFaddend exclusively decay to muons, are \DIFdelbegin \DIFdel{collected }\DIFdelend \DIFaddbegin \DIFadd{absorbed }\DIFaddend in the calorimeters 
  ...
  \section{\label{sec:detTrg}Trigger}
    ...
    \DIFdelbegin \DIFdel{The L1 trigger }\DIFdelend \DIFaddbegin \DIFadd{It uses only information from the calorimeter and muon systems and }\DIFaddend is used
      to identify events where the tracker should be read out.
    \DIFdelbegin \DIFdel{Only the calorimeters and the muon system are used in the L1 trigger.
    Each of the sub-detectors has its triggering hardware.
    }\DIFdelend The output from the sub-detectors is synchronized to ensure that the signal
      from each of the sub-detectors comes from the same collision. 
\DIFdelbegin \DIFdel{The global trigger hardware then makes the final decision to initiate the 
    ...
    For example, tracks can be associated with either ECAL energy clusters to 
      form electron candidates, \DIFaddbegin \DIFadd{or }\DIFaddend tracks can be combined with hits in the muon
    ...
    The two tiered triggering system creates very low dead times while 
      maintaining purity and selectivity\DIFdelbegin \DIFdel{.
    During data taking the L1 trigger is continuously monitoring, and the HLT
      allows for sophisticated event selection}\DIFdelend .
