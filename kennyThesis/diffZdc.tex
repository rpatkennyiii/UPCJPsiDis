\chapter{\label{ch:zdcReco}ZDC reconstruction}
  \section{\label{sec:breakUpDet} Nuclear break-up determination}
    ...
    This new reconstruction method was then used to establish 
      \DIFdelbegin \DIFdel{a one neutron and many neutron threshold}\DIFdelend \DIFaddbegin \DIFadd{thresholds for one and more than one neutron in each ZDC}\DIFaddend . 
    ...
    \subsection{ZDC signal reconstruction}
      ...
      The \DIFdelbegin \DIFdel{channel }\DIFdelend signal is therefore taken from the 4th time slice.
      \begin{figure}[h]
        \centering
    ...
    \subsection{Determination of the one neutron thresholds}
      ...
      Figure~\ref{fig:zdcM2Fit} shows the weighted sum of the EM and 
        ...
        dataset.
      The neutron spectrum for this dataset is \DIFaddbegin \DIFadd{not }\DIFaddend biased since the 
        trigger only required that both beams were present in CMS. 
      This \DIFaddbegin \DIFadd{dataset }\DIFaddend does, however, include a significant electronic noise contribution due
      ...
      To determine the thresholds for one and multiple neutrons, the ZDC$^{+}$ 
        ...
        \DIFdelbegin \DIFdel{fit.
      Four Gaussian functions were combined to fit the spectra}\DIFdelend \DIFaddbegin \DIFadd{each fit to the sum of four Gaussians}\DIFaddend . 
      ...
      To identify events where the ZDCs only measured noise, the noise
        \DIFdelbegin \DIFdel{spectrum }\DIFdelend \DIFaddbegin \DIFadd{spectra }\DIFaddend were measured directly.
    ...
    \subsection{\label{sec:zdcCompare}ZDC reconstruction method comparison}
      In this section the nominal ZDC reconstruction method designed for this
        thesis is compared to an alternative \DIFdelbegin \DIFdel{comparison }\DIFdelend method.
      This additional method, used in previous ZDC measurements, differs 
        ...
        each channel.
      In the additional \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend method, the signal is taken from the sum of 
      ...
      As in the nominal method described in Section~\ref{sec:breakUpDet}, 
        the \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend method combines the channels to create a signal 
      ...
      Figure~\ref{fig:zdcM1Fit} shows the spectra for ZDC$^{+}$ and ZDC${-}$ 
        using the \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend method. 
      The same fit used for the nominal method is applied to the \DIFdelbegin \DIFdel{comparison 
      ...
      \begin{figure}[!Hhtb]
        ...
        \caption{Fit to charge spectrum from ZDC$^{-}$ (left) and ZDC$^{+}$ 
          (right) using the \DIFdelbeginFL \DIFdelFL{comparison }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{alternative }\DIFaddendFL reconstruction method}
        \label{fig:zdcM1Fit}
      \end{figure}

      The advantage of the \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend method is that by using multiple signal
      ...
      The nominal method relative to the \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend method separates low signal
      ...
      The ZDC$^{+}$ and ZDC$^{-}$ signals near the one neutron peak using the
        \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend and nominal reconstruction methods were plotted for comparison in 
        Fig.~\ref{fig:zdcSpec2v1}.
      \begin{figure}[h]
        \centering
        \includegraphics[width=\textwidth]{zdcSpec2v1}
        \caption{Comparison of the nominal (red) ZDC reconstruction 
          method and the \DIFdelbeginFL \DIFdelFL{comparison }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{alternative }\DIFaddendFL (blue) method for ZDC$^{-}$ (left) and 
          ZDC$^{+}$ (right).}
      ...
      In Fig.~\ref{fig:zdcSpec2v1}, the shrinking of width of the noise peak 
        ...
        both ZDC$^{+}$ and ZDC$^{-}$.
      For the \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend method no single neutron peak is resolved in ZDC$^{+}$,
      ...
      Timing cuts were applied to enhance the signal relative to the background
        ...
        \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend method. 
      ...
      Using this fact, \DIFdelbegin \DIFdel{signal can be preferably }\DIFdelend \DIFaddbegin \DIFadd{neutron events can be }\DIFaddend selected by requiring that the
      ...
      Through these timing cuts the single neutron peak was recovered using the
       \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend reconstruction for ZDC$^{+}$.

      To examine the effectiveness of the timing cuts, event by event noise 
        subtraction was removed from the \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend reconstruction.
      ...
      Using the \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend noise subtraction method, the same signal that emerges
      ...
      Fig.~\ref{fig:zdcSpec2v1} demonstrates the correspondence between
        the nominal noise subtraction method and the \DIFdelbegin \DIFdel{comparison }\DIFdelend \DIFaddbegin \DIFadd{alternative }\DIFaddend method in 
        ZDC$^{-}$ where \DIFaddbegin \DIFadd{the }\DIFaddend signal is better separated from the electronic noise. 
