\chapter{\label{ch:analysis}Analysis}
  ...
  Finally, \DIFdelbegin \DIFdel{Section}\DIFdelend \DIFaddbegin \DIFadd{in Chapter}\DIFaddend ~\ref{sec:sysCheck} lays out the systematic uncertainties 
    for the measurement. 
  ...
  \DIFdelbegin \subsection{\DIFdel{MC and data comparisons}}
      %DIFAUXCMD
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdel{Comparison of the of the dimuon rapidity distributions between 
          coherent }%DIFDELCMD < \JPsi{} %%%
\DIFdel{MC sample and data.}}
        %DIFAUXCMD
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdel{Comparison of the of the dimuon $\varphi$ distributions 
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdel{Comparison of the of the dimuon }%DIFDELCMD < \pt{} %%%
\DIFdel{distributions 
          between coherent }%DIFDELCMD < \JPsi{} %%%
\DIFdel{MC sample and data.}}
        %DIFAUXCMD
...
\DIFdelend \subsection{STARlight and particle gun MC}
    ...
    In step 2, the STARlight output file is converted to the Les Houches \DIFaddbegin \DIFadd{Event 
      }\DIFaddend (LHE) format \cite{lheFormat}, and the momentum of the parent \JPsi{} or 
    ...
    \DIFaddbegin \DIFadd{Figures \ref{fig:jpsiAbsRapCoherent}, }{\DIFadd{fig:jpsiPhiCoherent}} \DIFadd{show  the rapidity, $\varphi$, and  }\pt{} \DIFadd{distributions of reconstructed coherent }\JPsi{} \DIFadd{MC from STARLight and data. All distributions are normalized to unity. The rapidity distribution of the STARLight is very slightly higher than for the data, with a difference in the mean rapidity of $\approx 0.1$ unit.  The $\varphi$, and  }\pt{} \DIFadd{distributions are for STARLight and data are both very similar. 
      }\begin{figure}[h]
        \centering
  ...
  \DIFaddend \section{\label{sec:DataSetEvSel} Event selection}
    ...
    Of this, 143 \DIFaddbegin \DIFadd{$\pm$ 7 (syst) }\DIFaddend $\mu$$b^{-1}$ of data were used in this analysis due to the 
    ...
    \subsection{Data sets}
      ...
      The \JPsi{} events discussed in this thesis were obtained \DIFaddbegin \DIFadd{by }\DIFaddend analyzing 
      ...
      The physics sample containing the \JPsi{} signal was recorded by the muon 
        trigger labeled \DIFdelbegin \DIFdel{"}\DIFdelend \DIFaddbegin \DIFadd{``}\DIFaddend L1UPCMuon and Pixel Track\DIFdelbegin \DIFdel{" }\DIFdelend \DIFaddbegin \DIFadd{'' }\DIFaddend in 
      ...
      Contributions from hadronic interactions \DIFdelbegin \DIFdel{are }\DIFdelend \DIFaddbegin \DIFadd{were }\DIFaddend reduced by the veto on the 
        BSCs.
      ...
      Neutron production is a much more common process than the UPC \JPsi{} 
        production.
      This process has cross sections on the order of \DIFdelbegin \DIFdel{100 }\DIFdelend \DIFaddbegin \DIFadd{200 }\DIFaddend b compared
    ...
    \subsection{Event selection cuts}
      The analysis described in this thesis focuses on UPC \JPsi{}s decaying to 
        muons. 
      The trigger used for this analysis \DIFdelbegin \DIFdel{recored }\DIFdelend \DIFaddbegin \DIFadd{recorded }\DIFaddend 346841 events.
      ...
      \begin{itemize}
          ...
          By requiring that the energy deposits in HF resemble noise, nearly all
            \DIFdelbegin \DIFdel{elastic }\DIFdelend \DIFaddbegin \DIFadd{inelastic }\DIFaddend hadronic collisions are expected to be rejected.
  ...
  \section{\label{sec:effDet} Efficiency determination}
    ...
    \subsection{Muon efficiencies}
      ...
      The efficiency for reconstructing single muons $\varepsilon^{\mu}_{reco}$ 
        ...
        after the full CMS detector simulation \DIFdelbegin \DIFdel{and }\DIFdelend that passed the standard
      ...
      The acceptance \DIFaddbegin \DIFadd{and reconstruction efficiency }\DIFaddend for reconstructing dimuons 
...
\DIFdelend \DIFaddbegin \begin{figure}[!Hhtb]
          \DIFaddendFL \centering
            \DIFdelbeginFL \DIFdelFL{$ \begin{array}{cc}
          ...
          \end{array} $
          }\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.45\textwidth]{accXeffFromMC1d}
          \DIFaddendFL \caption{Dimuon acceptance from coherent \JPsi{}\DIFdelbeginFL \DIFdelFL{(top left), incoherent 
            J$\psi$ (top right), and photon-photon interactions (lower)}\DIFdelendFL .}
...
\DIFaddend 
      ...
      The \DIFdelbegin \DIFdel{"}\DIFdelend \DIFaddbegin \DIFadd{``}\DIFaddend tag and probe method\DIFdelbegin \DIFdel{" }\DIFdelend \DIFaddbegin \DIFadd{'' }\DIFaddend is a data driven approach used to measure the 
      ...
      The average dimuon trigger efficiency for each dimuon \DIFdelbegin \DIFdel{(}%DIFDELCMD < \pt{}%%%
\DIFdel{,}\DIFdelend $|y|$ \DIFdelbegin \DIFdel{) }\DIFdelend bin
      ...
      \begin{figure}[!Hhbt]
        \centering
        \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.6\textwidth]{averageTriggerEff}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.6\textwidth]{muTrigEffFromTnP1d}
        \DIFaddendFL \caption{The trigger efficiency from tag and probe averaged over candidates
          in each \DIFdelbeginFL \DIFdelFL{(}%DIFDELCMD < \pt{}%%%
\DIFdelFL{,}\DIFdelendFL $|y|$ \DIFdelbeginFL \DIFdelFL{) }\DIFdelendFL bin.}
        \DIFdelbeginFL %DIFDELCMD < \label{fig:avTrigEffCo}
%DIFDELCMD <       %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:triggerEffDiMu}
      \DIFaddendFL \end{figure}
      The dimuon trigger efficiency ranges from about 50\% to 90\%. 
      As expected the \JPsi{} trigger efficiency \DIFdelbegin \DIFdel{increase }\DIFdelend \DIFaddbegin \DIFadd{increases }\DIFaddend with rapidity since 
        the longitudinal momentum of the \JPsi{} is given \DIFaddbegin \DIFadd{by 
        }\DIFaddend $p_Z= M_{J/\psi} \cdot sinh(y)$. 
      ...
      \begin{figure}[!Hhtb]
        \centering
        \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.6\textwidth]{averageExA}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.6\textwidth]{accXeffTrigg}
        \DIFaddendFL \caption{The acceptance times averaged trigger efficiency from tag and 
          probe.}
        \DIFdelbeginFL %DIFDELCMD < \label{fig:avAccEff}
%DIFDELCMD <       %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:averageExA}
      \DIFaddendFL \end{figure}

      The total combined efficiency and acceptance factor \DIFaddbegin \DIFadd{for }\DIFaddend coherent \JPsi{} 
      ...
      The interplay of the polarization of the \JPsi{} and the material in 
        detector \DIFdelbegin \DIFdel{drive }\DIFdelend \DIFaddbegin \DIFadd{drives }\DIFaddend down the efficiency by creating an effective momentum 
    ...
    \subsection{ZDC trigger efficiency}
      As discussed in Section~\ref{sec:breakUpDet}, the trigger labeled 
        \DIFdelbegin \DIFdel{"}\DIFdelend \DIFaddbegin \DIFadd{``}\DIFaddend L1ZDCOr and Pixel Track\DIFdelbegin \DIFdel{" }\DIFdelend \DIFaddbegin \DIFadd{'' }\DIFaddend in Table~\ref{tab:hltTriggers2011} was used 
