...
\DIFdelbegin \DIFdel{Finally, in Chapter~\ref{sec:sysCheck} lays out the systematic uncertainties 
    for the measurement. 
}\DIFdelend 
  ...
  \subsection{STARlight and particle gun MC}
    ...
    The STARlight samples correspond to the theoretical calculations 
      ...
      rest frame. 
    For STARlight, three different physical \DIFdelbegin \DIFdel{process }\DIFdelend \DIFaddbegin \DIFadd{processes }\DIFaddend were simulated:
    ...
    \JPsi{} mesons were created according to user defined \pt{} and rapidity
      distributions. 
    The decay of \JPsi{}s to a $\mu^{+}\MATHBLOCKDOLLARDOLLAR{\mu^{-}$ pair was simulated with
    ...
    However in the lab frame of the detector, the muon daughters which are 
      ...
      the direction the \JPsi{} is traveling and will have unequal \DIFdelbegin \DIFdel{momentum in 
      the lab frame}\DIFdelend \DIFaddbegin \DIFadd{momenta}\DIFaddend .
    ...
    \DIFdelbegin \DIFdel{In Fig.~\ref{fig:genHXAngle}, the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend cosine of the helicity angle\DIFdelbegin \DIFdel{of the 
      }\DIFdelend \DIFaddbegin \DIFadd{, the angle between the }\JPsi{} \DIFadd{spin vector
      in the rest frame and the direction of the boost to the lab frame, are 
      shown for the }\DIFaddend particle gun samples and the STARlight samples \DIFdelbegin \DIFdel{are shown}\DIFdelend \DIFaddbegin \DIFadd{in 
      Fig.~\ref{fig:genHXAngle}}\DIFaddend . 
    For the STARlight sample the helicity angle \DIFdelbegin \DIFdel{, the angle between the 
      direction of the $\mu^{+}$ daughter and the }%DIFDELCMD < \JPsi{} %%%
\DIFdel{direction in the rest
      frame of the }%DIFDELCMD < \JPsi{}%%%
\DIFdel{, }\DIFdelend prefer to be either parallel or
      anit-parallel.
    However, the particle gun samples have no preferred direction\DIFdelbegin \DIFdel{of emission}\DIFdelend .
    \begin{figure}[!Hhbt]
      \centering
    ...
    \end{figure}
      ...
      \DIFaddbegin \begin{figure}[!Hhbt]
        ...
        \caption{\DIFaddFL{Comparison of the of the dimuon rapidity distributions between 
          coherent }\JPsi{} \DIFaddFL{MC sample and data.}}
        \label{fig:jpsiAbsRapCoherent}
      \end{figure}
      \begin{figure}[!Hhbt]
        \centering
        \includegraphics[width=0.5\textwidth]{jpsiMcComp/jpsiPhiCoherent}
        \caption{\DIFaddFL{Comparison of the of the dimuon $\varphi$ distributions 
          between coherent }\JPsi{} \DIFaddFL{MC sample and data.}}
        \label{fig:jpsiPhiCoherent}
      \end{figure}
      \begin{figure}[!Hhbt]
        \centering
        \includegraphics[width=0.5\textwidth]{jpsiMcComp/jpsiPtCoherent}
        \caption{\DIFaddFL{Comparison of the of the dimuon }\pt{} \DIFaddFL{distributions 
          between coherent }\JPsi{} \DIFaddFL{MC sample and data.}}
        \label{fig:jpsiPtCoherent}
      \end{figure}
    \DIFaddend Figures \ref{fig:jpsiAbsRapCoherent}, \DIFdelbegin %DIFDELCMD < {%%%
\DIFdel{fig:jpsiPhiCoherent}%DIFDELCMD < } %%%
\DIFdelend \DIFaddbegin \DIFadd{\ref{fig:jpsiPhiCoherent}, and
      \ref{fig:jpsiPtCoherent} }\DIFaddend show  the rapidity, \DIFdelbegin \DIFdel{$\varphi$}\DIFdelend \DIFaddbegin \DIFadd{$\phi$}\DIFaddend , and  \pt{} 
      distributions of reconstructed coherent \JPsi{} \DIFdelbegin \DIFdel{MC from STARLight }\DIFdelend \DIFaddbegin \DIFadd{from STARLight MC }\DIFaddend and 
      data. 
    All distributions are normalized to \DIFdelbegin \DIFdel{unity. 
    The rapidity distribution }\DIFdelend \DIFaddbegin \DIFadd{one. 
    The mean }\DIFaddend of the STARLight \DIFdelbegin \DIFdel{is very slightly higher than for the data, with a difference in the mean rapidityof }\DIFdelend \DIFaddbegin \DIFadd{rapidity distribution is slightly shift by 
      }\DIFaddend $\approx 0.1$ \DIFdelbegin \DIFdel{unit. 
    The $\varphi$}\DIFdelend \DIFaddbegin \DIFadd{to higher rapidity. 
    The $\phi$}\DIFaddend , and  \pt{} distributions \DIFdelbegin \DIFdel{are for }\DIFdelend \DIFaddbegin \DIFadd{from }\DIFaddend STARLight and data are both
      very similar. 
\DIFdelbegin %DIFDELCMD < \begin{figure}[h]
%DIFDELCMD <         \centering
%DIFDELCMD <         \includegraphics[width=0.5\textwidth]{jpsiMcComp/jpsiAbsRapCoherent}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Comparison of the of the dimuon rapidity distributions between 
          coherent }%DIFDELCMD < \JPsi{} %%%
\DIFdelFL{MC sample and data.}}
        %DIFAUXCMD
%DIFDELCMD < \label{fig:jpsiAbsRapCoherent}
%DIFDELCMD <       \end{figure}
%DIFDELCMD <       \begin{figure}[h]
%DIFDELCMD <         \centering
%DIFDELCMD <         \includegraphics[width=0.5\textwidth]{jpsiMcComp/jpsiPhiCoherent}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Comparison of the of the dimuon $\varphi$ distributions 
          between coherent }%DIFDELCMD < \JPsi{} %%%
\DIFdelFL{MC sample and data.}}
        %DIFAUXCMD
%DIFDELCMD < \label{fig:jpsiPhiCoherent}
%DIFDELCMD <       \end{figure}
%DIFDELCMD <       \begin{figure}[h]
%DIFDELCMD <         \centering
%DIFDELCMD <         \includegraphics[width=0.5\textwidth]{jpsiMcComp/jpsiPtCoherent}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Comparison of the of the dimuon }%DIFDELCMD < \pt{} %%%
\DIFdelFL{distributions 
          between coherent }%DIFDELCMD < \JPsi{} %%%
\DIFdelFL{MC sample and data.}}
        %DIFAUXCMD
%DIFDELCMD < \label{fig:jpsiPtCoherent}
%DIFDELCMD <       \end{figure}
%DIFDELCMD < %%%
\DIFdelend 
  ...
  \section{\label{sec:DataSetEvSel} Event selection}
    ...
    During this period, 150 $\mu}b^{-1}$ were recorded by the CMS detector,
      corresponding to \DIFdelbegin \DIFdel{over a billion }\DIFdelend \DIFaddbegin \DIFadd{> 10$^{9}$ }\DIFaddend PbPb collisions. 
    ...
    \subsection{Data sets}
      The data were dived into three specially selected samples, Physics, Monitoring, 
        and Zero bias, based on the triggers which \DIFdelbegin \DIFdel{recored }\DIFdelend \DIFaddbegin \DIFadd{recorded }\DIFaddend the events (see 
      ...
      The purity, which is a measure of how many signal events relative to
        background events are in \DIFdelbegin \DIFdel{an }\DIFdelend \DIFaddbegin \DIFadd{a }\DIFaddend sample, is obtained by using more selective
        triggers.
      Less selective triggers, those assigned to the monitoring and zero bias 
        ...
        \DIFdelbegin \DIFdel{due to }\DIFdelend \DIFaddbegin \DIFadd{because of }\DIFaddend the higher selectivity of physics triggers. 
      ...
      A ZDC triggered monitoring sample was recorded for the sake of estimating
        efficiencies.
      Lastly, a zero bias sample was \DIFdelbegin \DIFdel{recored }\DIFdelend \DIFaddbegin \DIFadd{recorded }\DIFaddend for investigating the ZDC and the 
      ...
      The noise trigger rate for the muon trigger alone was 50 Hz, but in 
        ...
        below 2 Hz. 
      By pairing the muon trigger with the ZDC on the L1 \DIFaddbegin \DIFadd{trigger}\DIFaddend , the noise contribution
      ...
      Because the zero bias trigger only requires the \DIFdelbegin \DIFdel{presents }\DIFdelend \DIFaddbegin \DIFadd{presence }\DIFaddend of both LHC 
        beams, the sample contains very few hadronic collisions. 
      This allowed for a measurement of the electronic noise distribution \DIFdelbegin \DIFdel{in
        the HF , which are }\DIFdelend \DIFaddbegin \DIFadd{of
        the HF detector, which is }\DIFaddend important to reducing contamination from 
...
\cite{vanderMeer:1968zz}
    ...
    \subsection{Event selection cuts}
      ...
      A set of off-line cuts \DIFdelbegin \DIFdel{were }\DIFdelend \DIFaddbegin \DIFadd{was }\DIFaddend applied to increase the relative contribution 
      ...
      \DIFaddbegin \DIFadd{Figure~\ref{fig:evDisplay} shows a candidate event after applying all 
        event selection cuts. 
      }\DIFaddend \begin{table}[!Hhbt]
        \centering
      ...
      \DIFaddbegin \begin{figure*}[!Hhbt]
        ...
        \caption{\DIFaddFL{Event display of a UPC }\JPsi{} \DIFaddFL{candidate event.}}
      \label{fig:evDisplay}
      \end{figure*}
      \DIFaddend 
      ...
      \begin{itemize}
        \item The reconstructed vertex must be within 2 cm in 
          ...
          This cut requires that energy \DIFdelbegin \DIFdel{deposits }\DIFdelend \DIFaddbegin \DIFadd{deposited }\DIFaddend in the silicon tracker \DIFdelbegin \DIFdel{point 
            back to the reconstructed  }\DIFdelend \DIFaddbegin \DIFadd{have a
            shape consistant with the }\DIFaddend primary vertex. 
      \end{itemize}
      \DIFdelbegin \DIFdel{These }\DIFdelend \DIFaddbegin \DIFadd{When applied after all other cut these }\DIFaddend beam background cuts do not reject
      ...
      \begin{itemize}
  	    ...
  	    \DIFdelbegin \DIFdel{The track requirement rejects events that produce many charged 
          particles.
  	    }\DIFdelend \item Maximum reconstructed hit energy in HF was required to be below 
  ...
  \section{\label{sec:sigEx} Signal extraction}
    ...
    The photon-photon process is extended in invariant mass whereas the 
      \JPsi{} is \DIFdelbegin \DIFdel{peak }\DIFdelend \DIFaddbegin \DIFadd{peaked }\DIFaddend strongly near 3.1 GeV.
    \DIFdelbegin \DIFdel{In }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend dimuon transverse momentum distribution of the photon-photon and 
      \DIFaddbegin \DIFadd{the }\DIFaddend coherent process have similar distributions, both \DIFdelbegin \DIFdel{peaked shapely }\DIFdelend \DIFaddbegin \DIFadd{are sharply peaked 
        }\DIFaddend below 0.1 GeV, whereas the incoherent process is more broadly 
    ...
    There is a clear coherent peak at \pt{} = 60 MeV followed by \DIFaddbegin \DIFadd{a }\DIFaddend broad 
      distribution that \DIFdelbegin \DIFdel{peaks }\DIFdelend \DIFaddbegin \DIFadd{with a mean }\DIFaddend near \pt{} = 450 MeV. 
    ...
    \begin{figure}[!Hhbt]
      \centering
      \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.6\textwidth]{ptOnly}
%DIFDELCMD <       %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.6\textwidth]{gaussCC}
      \DIFaddendFL \caption{ Fit to MC \pt{} templates. }
      \label{fig:ptTemps}
    \end{figure}
  ...
  \section{\label{sec:effDet} Efficiency determination}
    ...
    The following section explains how each of these efficiencies \DIFdelbegin \DIFdel{were }\DIFdelend \DIFaddbegin \DIFadd{was }\DIFaddend measured
    ...
    \subsection{Muon efficiencies}
      ...
      The signal was fit using a Crystal Ball function \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{Gaiser:1982yw}
}%DIFAUXCMD
}\DIFaddend , and the background 
      ...
      \begin{figure}[!Hh]
        \centering
        \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.6\textwidth]{tNp/tnpFits}
%DIFDELCMD <         %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1.0\textwidth]{tNp/tnpFits}
        \DIFaddendFL \caption{Fits to tag and probe pairs in the \JPsi{} mass region for
    ...
    \subsection{ZDC trigger efficiency}
      ...
      \begin{table}
        ...
        \begin{tabular}{|c|c|c|c|c|}
           ...
           ZDC\DIFdelbeginFL \DIFdelFL{$^{+}$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$^{-}$ }\DIFaddendFL & 73028  & 71706  & 0.9819  $\pm$ 0.0037 \\ \hline
           ZDC\DIFdelbeginFL \DIFdelFL{$^{-}$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$^{+}$ }\DIFaddendFL & 76132  & 71859  & 0.9439  $\pm$ 0.0035 \\ \hline
        \end{tabular}
