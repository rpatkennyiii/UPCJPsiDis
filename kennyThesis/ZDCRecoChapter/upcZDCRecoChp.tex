  ...
  \section{\label{sec:breakUpDet} Nuclear break-up determination}
    ...
    \subsection{Determination of the one neutron thresholds}
      ...
      Figure~\ref{fig:zdcM2Fit} shows the weighted sum of the EM and 
        ...
        dataset.
      The neutron spectrum for this dataset is biased since the 
    ...
    \subsection{\label{sec:zdcCompare}ZDC reconstruction method comparison}
      In this section the nominal ZDC reconstruction method designed for this
        thesis is compared to an alternative comparison method.
      This additional method, used in previous ZDC measurements, differs 
        ...
        each channel.
      In the additional comparison method, the signal is taken from the sum of 
      ...
      As in the nominal method described in Section~\ref{sec:breakUpDet}, 
        the comparison method combines the channels to create a signal 
      ...
      The same fit used for the nominal method is applied to the comparison 
        method. 
      ...
      \begin{figure}[!Hhtb]
        ...
        \caption{Fit to charge spectrum from ZDC$^{-}$ (left) and ZDC$^{+}$ 
          (right) using the comparison reconstruction method}
        \label{fig:zdcM1Fit}
      \end{figure}

      The advantage of the comparison method is that by using multiple signal
      ...
      The nominal method relative to the comparison method separates low signal
      ...
      The ZDC$^{+}$ and ZDC$^{-}$ signals near the one neutron peak using the
        comparison and nominal reconstruction methods were plotted for comparison in 
        Fig.~\ref{fig:zdcSpec2v1}.
      \begin{figure}[h]
        \centering
        \includegraphics[width=\textwidth]{zdcSpec2v1}
        \caption{Comparison of the nominal (red) ZDC reconstruction 
          method and the comparison (blue) method for ZDC$^{-}$ (left) and 
          ZDC$^{+}$ (right).}
      ...
      In Fig.~\ref{fig:zdcSpec2v1}, the shrinking of width of the noise peak 
        ...
        both ZDC$^{+}$ and ZDC$^{-}$.
      For the comparison method no single neutron peak is resolved in ZDC$^{+}$,
      ...
      Through these timing cuts the single neutron peak was recovered using the
       comparison reconstruction for ZDC$^{+}$.

      To examine the effectiveness of the timing cuts, event by event noise 
        subtraction was removed from the comparison reconstruction.
      ...
      Using the comparison noise subtraction method, the same signal that emerges
      ...
      Fig.~\ref{fig:zdcSpec2v1} demonstrates the correspondence between
        the nominal noise subtraction method and the comparison method in 
