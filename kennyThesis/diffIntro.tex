\chapter{Introduction}
  ...
  At AGS\DIFdelbegin \DIFdel{the ion isotopes }\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend $^{16}$O, $^{28}$Si, and $^{197}$Au beams were 
    collided with fix targets. 
  At SPS the same fix target configuration was used, but \DIFdelbegin \DIFdel{the ion isotopes were 
    }\DIFdelend \DIFaddbegin \DIFadd{with 
    }\DIFaddend $^{16}$O, $^{32}$S, and $^{208}$Pb \DIFaddbegin \DIFadd{beams}\DIFaddend .
  ...
  GeV/ \DIFdelbegin \DIFdel{$fm^{3}$} \DIFdelend \DIFaddbegin \DIFadd{fm$^{3}$ } \DIFaddend and a temperature near 170 MeV~\cite{Karsch:2000kv,Hands:2001ve}.
  ...
  The energies at RHIC were a factor of 10 higher than was previously achieved
    \DIFdelbegin \DIFdel{reaching }\DIFdelend \DIFaddbegin \DIFadd{when running at }\DIFaddend the designed maximum energy. 
  ...
  The correlations between the rapidity of \JPsi{}\DIFaddbegin \DIFadd{'}\DIFaddend s and neutrons in 
  ...
  \section{Variables in heavy-ion measurements}
    ...
    \DIFaddbegin \DIFadd{The radius of curvature of the track is related to the momentum 
      due to the curved path of the particle in a magnetic field. 
    }\DIFaddend In CMS tracks are mapped out from measuring charge deposits in silicon
      cells.
    ...
    Energy \DIFdelbegin \DIFdel{are }\DIFdelend \DIFaddbegin \DIFadd{is }\DIFaddend typically measured by a calorimeter and momentum by a tracker.
    ...
    \DIFaddbegin \DIFadd{The polar angle for the beam with respect to the beam line defines $\theta$.
    }\DIFaddend If $m << p$, where $m$ is the mass of the particle, the 
  ...
  \section{Temperature and energy density of the QGP}
    Lattice QCD predicts that the \DIFdelbegin \DIFdel{QPG }\DIFdelend \DIFaddbegin \DIFadd{QGP }\DIFaddend forms above a critical temperature and 
      energy density, 170 MeV and 1.5 GeV/ \DIFdelbegin \DIFdel{$fm$$^{-3}$} \DIFdelend \DIFaddbegin \DIFadd {fm$^{-3}$} \DIFaddend ~\cite{Karsch:2000kv,Hands:2001ve}.
    ...
    from PHENIX was measured at RHIC to be 5.4$\pm$0.6 GeV \DIFdelbegin \DIFdel{$fm^{-2}$}\DIFdelend \DIFaddbegin \DIFadd{fm$^{-2}$} \DIFaddend c$^{-1}$ 
      for the centrality interval 0-5\%. 
    At the LHC CMS measured $\tau\cdot\epsilon_{Bj}$ = 14 GeV \DIFdelbegin \DIFdel{$fm^{-2}$}\DIFdelend \DIFaddbegin \DIFadd{fm$^{-2}$} \DIFaddend c$^{-1}$ 
      for the same centrality interval.
    Both values are well above the critical energy density of about 1.5 GeV/\DIFdelbegin \DIFdel{$fm$}\DIFdelend \DIFaddbegin \DIFadd{fm}\DIFaddend $^{3}$ 
      calculated from lattice QCD when assuming a medium formation time $\tau$ 
      = 1 \DIFdelbegin \DIFdel{$fm$}\DIFdelend \DIFaddbegin \DIFadd{fm}\DIFaddend /$c$.
      \begin{figure}[!Hhbt]
        \centering
    ...
    The PHENIX measurement was taken from pp collisions and \DIFaddbegin \DIFadd{the }\DIFaddend top 20\% most 
    ...
    For the ALICE measurement, the double ratio between the inclusive photons 
      to \DIFdelbegin \DIFdel{pions }\DIFdelend \DIFaddbegin \DIFadd{photons from pion decays }\DIFaddend over the ratio between photons coming from all decays 
      \DIFdelbegin \DIFdel{and pions 
      }\DIFdelend \DIFaddbegin \DIFadd{to photons from  pion decays }\DIFaddend was measured to estimate the direct 
      contribution.
    This double ratio is equal to the fraction of all photons which come from 
      decays. 
    All photons that do not come from decays are direct photons\DIFdelbegin \DIFdel{, therefore 
      the fraction of inclusive photons that are direct can be found from the ratio of decay photons to inclusive photons. 
  ...
  \section{Recent results from heavy-ion control measurements}
    ...
    The pPb $v_{2}$ measurement underscores the need for a clean probes of the 
      initial \DIFaddbegin \DIFadd{state}\DIFaddend . 
