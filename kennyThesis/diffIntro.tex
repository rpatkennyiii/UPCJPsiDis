\chapter{Introduction}
  ...
  As a result of recent LHC studies described in this thesis, physicists now 
    have better constraints on the QGP properties \DIFdelbegin \DIFdel{like }\DIFdelend \DIFaddbegin \DIFadd{such as }\DIFaddend temperature, viscosity, 
    and energy density.

  The detailed studies of PbPb collisions coming out of the LHC 
    experiments are in need of \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{an }\DIFaddend understanding of the initial state of the ions 
    before they collide.
  ...
  The current understanding of heavy-ion collisions evolved over the
    last 30 years.
  Relativistic heavy-ion collisions were first studied \DIFdelbegin \DIFdel{using }\DIFdelend \DIFaddbegin \DIFadd{at Belavac at the Lawrence 
    Berkeley National Laboratory (LBNL) in 1974, then at }\DIFaddend the 
    Alternating Gradient Synchrotron (AGS) at Brookhaven National \DIFdelbegin \DIFdel{Lab }\DIFdelend \DIFaddbegin \DIFadd{Laboratory }\DIFaddend (BNL) 
  ...
  By measuring UPC \JPsi{} events, theoretical models of the initial state can 
    be constrained.
  In \DIFaddbegin \DIFadd{addition, these constraints will provide the important benchmarks needed 
    to design a future electron-ion collider dedicated to exploring the nuclear
    initial state. 
  In }\DIFaddend this thesis, the CMS capability for measuring this process, the 
  ...
  \DIFaddbegin \DIFadd{The correlations between the rapidity of }\JPsi{}\DIFadd{s and neutrons in 
  ...
  The transverse energy and direct photons measurements are related to 
    the energy density and temperature of the QGP\DIFdelbegin \DIFdel{, which provide a 
    confirmation of the production of QGP}\DIFdelend .
  The elliptic flow measurement is related to the viscosity of the QGP\DIFdelbegin \DIFdel{, which
    provides insight into the fluid like nature of the QGP state}\DIFdelend .
  Before discussing these results, several terms used to describe heavy-ion
    measurements and detectors will be \DIFdelbegin \DIFdel{discussed}\DIFdelend \DIFaddbegin \DIFadd{presented}\DIFaddend . 
  ...
  \section{Variables in heavy-ion measurements}
    \DIFdelbegin \DIFdel{The variables used by heavy-ion experiments at colliding beam facilities, 
      such as the LHC and RHIC, are due to the cylindrical configuration of 
      the detectors around the line of the beams.
    }\DIFdelend Two types of generic detectors are in use in heavy-ion experiments, 
    ...
    In CMS tracks are mapped out from measuring charge deposits \DIFdelbegin \DIFdel{of }\DIFdelend in silicon
      cells.
    ...
    Tracker measurements will typically provide a rapidity value with 
      ...
      based \DIFaddbegin \DIFadd{on }\DIFaddend the angle $\theta$ with respect to the interaction point.
  ...
  \section{Temperature and energy density of the QGP}
    Lattice QCD predicts that the QPG forms above a critical temperature and 
      energy \DIFdelbegin \DIFdel{densities}\DIFdelend \DIFaddbegin \DIFadd{density}\DIFaddend , 170 MeV and 1.5 GeV/$fm$$^{-3}$\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{}
}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{~\mbox{%DIFAUXCMD
\cite{Karsch:2000kv,Hands:2001ve}
}%DIFAUXCMD
}\DIFaddend .
    The measurement of \DIFdelbegin \DIFdel{the }\DIFdelend $\frac{dE_{T}}{d\eta}$ provides a means of 
    ...
    The temperature can be estimated from the transverse momentum 
      spectrum of the direct photons, \DIFdelbegin \DIFdel{with }\DIFdelend \DIFaddbegin \DIFadd{which }\DIFaddend are photons that are produced 
    ...
    The formation time times the energy density, \DIFdelbegin \DIFdel{$\tau\dot\epsilon_{Bj}$}\DIFdelend \DIFaddbegin \DIFadd{$\tau\cdot\epsilon_{Bj}$}\DIFaddend , 
      from PHENIX was measured at RHIC to be 5.4$\pm$0.6 GeV $fm$$^{-2}$c$^{-1}$ 
      for the centrality interval 0-5\%\DIFaddbegin \DIFadd{. 
    }\DIFaddend At the LHC CMS measured \DIFdelbegin \DIFdel{$\tau\dot\epsilon_{Bj}$ }\DIFdelend \DIFaddbegin \DIFadd{$\tau\cdot\epsilon_{Bj}$ }\DIFaddend = 14 GeV $fm$$^{-2}$c$^{-1}$ 
    ...
    The PHENIX measurement was taken from pp collisions and top 20\% most 
      energetic AuAu collisions\DIFdelbegin \DIFdel{, collisions with a centrality of 0-20\%}\DIFdelend . 
    ...
    In the PHENIX measurement this was done by fitting to the mass 
      distribution of the electron-positron pair for each \pt{} \DIFaddbegin \DIFadd{bin}\DIFaddend .
    For the ALICE measurement, the double ratio between the inclusive photons 
      to pions over the ratio between photons \DIFdelbegin \DIFdel{from hadron }\DIFdelend \DIFaddbegin \DIFadd{coming from all }\DIFaddend decays and pions 
      was measured to estimate the direct contribution.
    \DIFaddbegin \DIFadd{This double ratio is equal to the fraction of all photons which come from 
      decays. 
    All photons that do not come from decays are direct photons, therefore 
      the fraction of inclusive photons that are direct can be found from the
      ratio of decay photons to inclusive photons. 
    }\DIFaddend The inclusive photon \pt{} spectra were then rescaled by the direct 
      photon fractions.
  ...
  \section{Elliptic flow and viscosity in the QGP \label{sec:elipFlow}}
    ...
    The event-plane angle \DIFaddbegin \DIFadd{is the azimuthal angle of the maximal flow of 
      the final state particles.   
    The event-plane angle }\DIFaddend accounts for the random orientation of the 
    ...
    In Fig.~\ref{fig:elipFlow}, $v_{2}/\epsilon$ is plotted as a function of 
      ...
      $S$ \cite{etaOvSinit}. 
    The model calculation was performed for \DIFaddbegin \DIFadd{the }\DIFaddend four values of the ratio of the 
      shear viscosity over entropy density, $\eta/s$, \DIFdelbegin \DIFdel{which are 
      }\DIFdelend \DIFaddbegin \DIFadd{of 
      }\DIFaddend 0.0, 0.08, 0.16, and 0.24.
    The $\eta/s$ value which gives the best agreement with data in 
      ...
      calculation.
    The \DIFaddbegin \DIFadd{KLN model in the upper right portion of Fig.~\ref{fig:elipFlow} is based on
    ...
    The }\DIFaddend observed strong dependence is one of the primary reason
  ...
  \section{Recent results from heavy-ion control measurements}
    ...
    This method differs from the event plan method discussed above, in that 
      ...
      of the tracks with respect to the \DIFdelbegin \DIFdel{events plan }\DIFdelend \DIFaddbegin \DIFadd{event plane }\DIFaddend angle.
    ...
    The range shown in Fig.~\ref{fig:pPbFlow} corresponds to the number of 
      tracks present in PbPb collisions for centrality values between \DIFdelbegin \DIFdel{50-60}\DIFdelend \DIFaddbegin \DIFadd{50-100}\DIFaddend \%.
