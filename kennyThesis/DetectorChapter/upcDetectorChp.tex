\chapter{\label{ch:detector} The Compact Muon Solenoid detector}	
  ...
  CMS was optimized efficient muon triggering and identification. 
  ...
  \section{Tracker}
    ...
    As opposed to the deflection angle set by the strength of the magnetic 
      ...
      the loss of energy due to multiple scattering of these particles off the material 
      of the detector.
  ...
  \section{Muons}
    ...
    It consists of three complementary systems: drift tube (DT) in the
