\chapter{Analysis}
  ...
  \section{\label{sec:mcSim} MC simulation}
    ...
    The set of events that are produced resemble as closely as possible the 
      ...
      by the detector and physical process being simulated.
    ...
    All three STARlight samples contain a $\mu^{+}$ and $\mu^{-}$ in the final 
      state.
    The second class uses PYTHIA6 to decay J/$\psi$s produced with a user 
      defined $p_{T}$ and rapidity distribution into muon pairs.
    ...
    In step 2 the STARlight output file is converted to the Les Houches (LHE) 
      format \cite{lheFormat}, and the momentum of the parent J/$\psi$ or the 
    ...
    J/$\psi$ mesons were created according to user defined $p_{T}$ and rapidity
      distributions. 
    PYTHIA6 \cite{pythia} decays the J/$\psi$s to $\mu^{+}$ and $\mu^{-}$.
    ...
    The various MC samplesv, three STARlight samples differ primarily in the 
      $p_{T}$ distribution and the polarization of the J/$\psi$s produced. 
...
%%%%%Fix this paragraph%%%%%%
  ...
  \section{\label{sec:TrigDev} Trigger development} 
    ...
    The 2010 rates were used to extrapolate to the interaction rate expected 
      prior to the 2011 run. 
    ...
    The extrapolated rates allowed for the create of a package of triggers to 
    ...
    By balancing the competing objectives of rate reduction and increasing 
      ...
      the prescales for the trigger were as seen in Table~\ref{tab:l1Triggers2011}.
    ...
    \subsection{\label{sec:l1Trigger} L1 trigger}
      ...
      \begin{table}[h]
        ...
        \begin{tabular}{|l|l|l|l|l|}
          ...
          MuonOpen and (ZDC$^{+}$~or~ZDC$^{-}$) and BSC veto & 2.1 & 1 & 1 & Physics \\  \hline
          ECAL2 and (ZDC$^{+}$~or~ZDC$^{-}$) and BSC veto & 1.8 & 2 & 2 & Physics \\  \hline
          ECAL5 and (ZDC$^{+}$~or~ZDC$^{-}$) and BSC veto & 0.3 & 1 & 3 & Physics \\  \hline
          (ZDC$^{+}$~or~ZDC$^{-}$) & 35 & 1500 & 4 & Monitor \\  \hline
          MuonOpen and (ZDC$^{+}$~or~ZDC$^{-}$) and HF veto & 0 & off & 5 & Backup \\  \hline
          ECAL2 and (ZDC$^{+}$~or~ZDC$^{-}$) and HF veto & 0 & off & 6 & Backup \\  \hline
          ECAL5 and (ZDC$^{+}$~or~ZDC$^{-}$) and HF veto & 0 & off & 7 & Backup \\  \hline
        \end{tabular}
    ...
    \subsection{HLT trigger}
      ...
      \begin{table}[h]
        ...
        \begin{tabular}{|l|l|l|l|l|l|}
          ...
          MuPixel\_SingleTrack & 0.52 & 1 & 1 & 1 & Physics   \\ \hline
          EG2Pixel\_SingleTrack & 1.65 & 2 & 1 & 2 & Physics   \\ \hline
          EG5Pixel\_SingleTrack & 0.26 & 1 & 1 & 3 & Physics   \\ \hline
          ZDC\_PlusOrMinus & 3.6 & 1500 & 11 & 4 & Monitor  \\ \hline
          ZDC\_PlusOrMinusPixel\_SingleTrack & 2.8 & 1500 & 1 & 4 & Monitor \\ \hline
          HfMuPixel\_SingleTrack & 0 & off & off & 5 & Backup   \\ \hline
          HfEG2Pixel\_SingleTrack & 0 & off & off & 6 & Backup   \\ \hline
          HfEG5Pixel\_SingleTrack & 0 & off & off & 7 & Backup   \\ \hline 
        \end{tabular}
    ...
    \subsection{Event selection cuts}
      ...
      \begin{table}
        ...
        \begin{tabular}{|c|c|c|} \hline 
          ...
          \multirow{2}{*}{kinematic cut} & J/$\psi$ mass requirement & 696 \\ \hhline{~--}
  ...
  \section{\label{sec:effDet} Efficiency determination}
    \subsection{Muon efficiencies}
      ...
      \begin{figure}[!Hh]
        ...
        \caption{Fits to tag and probe pairs in the J/$\psi$ mass region for
