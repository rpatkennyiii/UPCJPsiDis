\chapter{\label{ch:analysis}Analysis}
  ...
  Finally, in Chapter~\ref{sec:sysCheck} lays out the systematic uncertainties 
    for the measurement. 
  ...
  \subsection{STARlight and particle gun MC}
    ...
    Figures \ref{fig:jpsiAbsRapCoherent}, {fig:jpsiPhiCoherent} show  the rapidity, $\varphi$, and  \pt{} distributions of reconstructed coherent \JPsi{} MC from STARLight and data. All distributions are normalized to unity. The rapidity distribution of the STARLight is very slightly higher than for the data, with a difference in the mean rapidity of $\approx 0.1$ unit.  The $\varphi$, and  \pt{} distributions are for STARLight and data are both very similar. 
      \begin{figure}[h]
        \centering
