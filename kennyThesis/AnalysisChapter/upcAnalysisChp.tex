...
%%%%%%Fix this table%%%%%%%%%%%%%%%%%%%%%%%%%%
      \begin{table}[h]
        ...
        \begin{tabular}{|l|l|}
          ...
          MuonOpen and (ZDC$^{+}$ or ZDC$^{-}$) and BSC veto & Physics \\  \hline
          ECAL2 and (ZDC$^{+}$ or ZDC$^{-}$) and BSC veto & Physics \\  \hline
          ECAL5 and (ZDC$^{+}$ or ZDC$^{-}$) and BSC veto & Physics \\  \hline
          (ZDC$^{+}$ or ZDC$^{-}$) & Monitor \\  \hline
          MuonOpen and (ZDC$^{+}$ or ZDC$^{-}$) and HF veto & Backup \\  \hline
          ECAL2 and (ZDC$^{+}$ or ZDC$^{-}$) and HF veto & Backup \\  \hline
          ECAL5 and (ZDC$^{+}$ or ZDC$^{-}$) and HF veto & Backup \\  \hline
        \end{tabular}
...
%%%%%%Fix this table%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{table}[h]
	...
	\end{table}
      ...
      To meet the bandwidth the requirements and collect a significant sample
