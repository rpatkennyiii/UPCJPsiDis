...
\chapter{\label{ch:analysis} Analysis}
  ...
  \section{\label{sec:sysCheck}Systematic uncertainties}
    ...
    \begin{table}[!Hhtb]
      \begin{center}
        \begin{tabular}{|c|c|c|}
          ...
          Template fit normalization & +9.5\% -12\%    \\ \hline
    ...
    \subsection{ZDC trigger efficiency}
      ...
      The uncertainty in the ZDC trigger efficiency is taken to be 1\% for 
      ZDC$^{-}$ and 4\% for ZDC$^{+}$.
