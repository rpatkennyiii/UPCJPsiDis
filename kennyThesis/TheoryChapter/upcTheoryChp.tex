\chapter{Theory}
  \section{Introduction}
    ...
    The LHC is producing rare experimental probes such as suppressed jets and 
      heavy quarkonia at an unprecedented rate. 
    ...
    The colliding nuclei interact electromagnetically in an UPC event, avoiding
      the confusion of nuclear collisions.
    ...
    UPC events are a probe of the nuclei before they collide that is 
      uncontaminated by QGP effects.  
    ...
    The interactions between the field of photons surrounding the colliding 
      ...
      gluon density.
    The UPC $J/\Psi$ photoproduction cross section is therefore a probe of the 
      the initial state of the nucleus. 
    The Weizsacker-Williams approximation provides a way to calculate the 
    ...
    The perterbutive Quantum Chromodynamics (pQCD), Vector Messon Dominance 
  ...
  \section{Weizacker Williams Approximation}
    The Weizacker-Williams approximation relates the electric field of a 
    ...
    A Fourier transform of Maxwell's equations combine with Einstein's equation 
      for the energy of a photon in the Weizacker-Williams approximation.
    ...
    The Weizsacker-Williams approximation makes the calculation of 
    ...
    Physicists can calculate the electromagnetic interactions between nuclei 
      with the final result of the Wiezacker-Willaims approximation, 
  ...
  \section{Vector Meson Dominance}
    ...
    VMD approach is constructed from the Weizsacker-Williams photon
      ...
      sections.
    The Weizsacker-Williams photon flux provides the probe. 
    The proton-electron scattering data combine with the Glauber model and 
    ...
    The Weizsacker-Williams approximation, Eq.~\ref{eq:photonFluxFinaltmp}, 
    ...
    $W$ is the center of mass energy of the proton-photon system in 
      Eq.~\ref{eq:proElFit}.
    The remaining variables in Eq.~\ref{eq:proElFit} are simply powerlaw-fit
      parameters.  
  ...
  \section{Leading Twist Approach Derivation}
    ...
    The LTA method uses the Weizacker-Williams approximation to calculate 
  ...
  \section{Perturbative Quantum Chromodynamics}
    To calculate the UPC $J/\Psi$ photoproduction cross section, the pQCD 
      ...
      the Wiezacker-Willaims approximation for the probing photon flux. 
    The pQCD method combines these components such that the nuclear gluon 
      density is a direct variable.
    The direct use of the nuclear gluon density in the pQCD method allows for 
    ...
    The total cross section for photoprduction, Eq.~\ref{eq:pQCDtotXSec}, 
  ...
  Each of these methods utilizes the same probe of the nucleus, the equivalent 
    photon flux that is calculated using the Weizsacker-Williams approximation. 
  ...
  S can be measured from data by assuming a Weizacker-Williams photon flux and 
