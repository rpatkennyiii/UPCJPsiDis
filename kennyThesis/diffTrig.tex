\chapter{\label{ch:trigg}UPC trigger development for CMS}
  ...
  \section{\label{sec:l1Trigger}L1 trigger}
    ...
    The ECAL2 and ECAL5 triggers in Table~\ref{tab:l1Triggers2011}
      indicate a \DIFdelbegin \DIFdel{5 and }\DIFdelend 2 \DIFaddbegin \DIFadd{and 5 }\DIFaddend GeV threshold on $E_{T}$ measured in the ECAL.
    ...
    This requirement \DIFdelbegin \DIFdel{comes }\DIFdelend \DIFaddbegin \DIFadd{came }\DIFaddend from the need to keep the tracker read-out rate
      low. 
    ...
    \DIFdelbegin \DIFdel{In order to record the efficiency monitoring data, the ZDC triggers were
      reduce to a lower rate by only keeping a fraction of the total trigger 
      rate}\DIFdelend \DIFaddbegin \DIFadd{The (ZDC$^{+}$ or ZDC$^{-}$) was used to estimate the efficiency of the UPC electron and muon triggers}\DIFaddend . 
    The factor that the \DIFdelbegin \DIFdel{trigger }\DIFdelend rate is reduced by is called the prescale.
  ...
  \section{\label{sec:hltTrigger}HLT trigger}
    ...
    The UPC triggers were required to have at lease one reconstructed pixel 
      track in order to reject backgrounds where no particles \DIFdelbegin \DIFdel{are 
      }\DIFdelend \DIFaddbegin \DIFadd{were 
      }\DIFaddend reconstructed by the tracker.
  ...
  \section{Studies of 2011 PbPb data}
    ...
    \subsection{UPC \JPsi{} with \DIFdelbegin \DIFdel{muons }\DIFdelend \DIFaddbegin \DIFadd{electrons }\DIFaddend in HF}
      ...
      HF extends to 5 in $\eta$, which is 2.6 units beyond the edge of the 
        tracker.
      By combining hits in HF with tracks in the tracker\DIFdelbegin \DIFdel{the higher dimuon 
        rapidities could be explored}\DIFdelend \DIFaddbegin \DIFadd{,  
        }\JPsi{} \DIFadd{from higher rapidities can be measured}\DIFaddend . 
 ...
 \section{\label{sec:pPbTrigDev}Trigger development for the LHC pPb Run}
   Specific UPC triggers were also developed for the pPb run in 2013. 
    ...
    The basic strategy in 2013 was the same as in 2012, use the loosest 
      available ECAL and muon L1 triggers \DIFdelbegin \DIFdel{to push }\DIFdelend to capture the lowest \pt{}
