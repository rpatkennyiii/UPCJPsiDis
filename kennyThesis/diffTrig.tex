\chapter{\label{ch:trigg}UPC trigger development for CMS}
  \DIFdelbegin \DIFdel{Rare physics process at the LHC require dedicated triggers in order to sort
    these processes from the billions }\DIFdelend \DIFaddbegin \DIFadd{In the 2011 LHC PbPb run the rate of UPC J/$\psi$ production was about 
    10$^{5}$ times smaller than that }\DIFaddend of ordinary nucleus-nucleus collisions.
  \DIFaddbegin \DIFadd{To recorded these events dedicated UPC triggers were needed. 
  }\DIFaddend Unlike most heavy-ion triggers, UPC triggers are optimized for low-\pt{} 
  ...
  \section{\label{sec:l1Trigger}L1 trigger}
    ...
    A prescale of 2 for example means that half the triggers \DIFdelbegin \DIFdel{that }\DIFdelend were 
      accepted.
  ...
  \section{Studies of 2011 PbPb data}
    ...
    \subsection{High mass $\gamma\gamma \rightarrow e^{+} e^{-}$  in PbPb 2011}
      ...
      Because of the smaller mass of the electron,
        dielectron production is slightly \DIFdelbegin \DIFdel{favor }\DIFdelend \DIFaddbegin \DIFadd{favored }\DIFaddend compared to dimuon 
        production.
      ...
      The ECAL is \DIFdelbegin \DIFdel{position }\DIFdelend \DIFaddbegin \DIFadd{positioned }\DIFaddend just beyond the tracker, whereas the muon system is 
        the outermost sub-detector.
      \DIFdelbegin \DIFdel{This elevates the main reduction of muon acceptance}\DIFdelend \DIFaddbegin \DIFadd{Electrons would therefore be less effected by the material budget}\DIFaddend , which
        is the \DIFdelbegin \DIFdel{material
        budget}\DIFdelend \DIFaddbegin \DIFadd{main factor in reducing yields of reconstructed dimuon 
      ...
      Because the Pb nucleus has a charge 82 times higher than \DIFaddbegin \DIFadd{that of }\DIFaddend the 
        proton, the electromagnetic coupling is stronger\DIFdelbegin \DIFdel{, and therefore, }\DIFdelend \DIFaddbegin \DIFadd{. 
      Thus }\DIFaddend higher order terms \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{in }\DIFaddend the perturbative expansion \DIFdelbegin \DIFdel{would }\DIFdelend \DIFaddbegin \DIFadd{could }\DIFaddend potentially 
        be more important \DIFdelbegin \DIFdel{.
      By measuring the cross section for $\gamma\gamma \rightarrow e^{+} e^{-}$,
        ...
        coupling can be constrained}\DIFdelend \DIFaddbegin \DIFadd{for the Pb nucleus compared to the proton}\DIFaddend .
      Recent results by ALICE favor very small contributions for higher order
        terms \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{}
}%DIFAUXCMD
...
\cite{Abbas:2013oua}
      ...
      In addition, this analysis provides a useful cross check to the UPC 
        quarkonia \DIFdelbegin \DIFdel{analysis }\DIFdelend \DIFaddbegin \DIFadd{analyses }\DIFaddend such as \JPsi{} by verifying the cross section 
        normalization.
    ...
    \subsection{UPC \JPsi{} with electrons in HF}
      ...
      Because these two contributions to the UPC photoproduction cross section 
        ...
        higher \DIFdelbegin \DIFdel{dimuon }\DIFdelend \DIFaddbegin \DIFadd{dilepton }\DIFaddend rapidities becomes attractive.
      ...
      When combined with neutron tagging of incoherently produced quarkonia,
        ...
        by identifying \DIFdelbegin \DIFdel{muons }\DIFdelend \DIFaddbegin \DIFadd{leptons }\DIFaddend in HF. 
 ...
 \section{\label{sec:pPbTrigDev}Trigger development for the LHC pPb Run}
   Specific UPC triggers were also developed for the pPb run in 2013. 
    ...
    In addition, \DIFdelbegin \DIFdel{an increase in cross section of the underlying physics process
      was achieved by relaxing the neutron emission requirement}\DIFdelend \DIFaddbegin \DIFadd{the cross section for photoproduciton without regard to 
      neutron emission is higher.
    Therefore, relaxing the requirement of activity in the ZDCs further 
      increases measurable yields}\DIFaddend . 
    ...
    \begin{itemize}
      \item Pixel tracks were reconstructed from the inner pixel section of the 
        \DIFdelbegin \DIFdel{silicone }\DIFdelend \DIFaddbegin \DIFadd{silicon }\DIFaddend tracker alone, tracks were reconstructed using the full
    ...
    \subsection{$J/\psi$ photoproduction in ultra-peripheral pPb collisions}
      The CMS UPC triggers commissioned for the 2013 LHC pPb \DIFaddbegin \DIFadd{run }\DIFaddend will allow for
        \DIFdelbegin \DIFdel{the
        study }\DIFdelend \DIFaddbegin \DIFadd{further analysis }\DIFaddend of \JPsi{} photoproduciton.
      \DIFdelbegin \DIFdel{This process }\DIFdelend \DIFaddbegin \DIFadd{In ultra-peripheral pPb collisions, }\JPsi{} \DIFadd{photoproduciton }\DIFaddend is dominated 
      ...
      In Eq.~\ref{eq:photonFluxFinaltmp} the photon flux depends on the square
        of the number of protons in \DIFaddbegin \DIFadd{the }\DIFaddend parent nucleus, $Z^{2}$. 
      However, the cross section of the target \DIFdelbegin \DIFdel{only }\DIFdelend increase as the total 
        number of nucleons to \DIFaddbegin \DIFadd{the two thirds power, }\DIFaddend $A^{2/3}$.
      ...
      In addition, an excess in the UPC cross section compared to HERA 
        ...
        \JPsi{} cross section. 
      This measurement will \DIFdelbegin \DIFdel{both help }\DIFdelend enhance the current understanding of 
        the \DIFdelbegin \DIFdel{$\gamma$p }\DIFdelend \JPsi{} photoproduction cross section as a function of \DIFaddbegin \DIFadd{the 
        photon-proton center of mass energy, }\DIFaddend $W_{\gamma p}$.
