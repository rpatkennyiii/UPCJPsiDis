...
\begin{abstract}
  ...
  The cross section corrected for break-up mode is found to be 
    1.80 $\pm$ 0.37 (stat) $^{+0.22}_{-0.25}$ (syst) mb, in agreement with 
    theoretical predictions and previous measurements by the ALICE 
    collaboration.
