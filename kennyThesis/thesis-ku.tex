...
\begin{abstract}
  ...
  The cross section for coherent \JPsi{} photoproduction in the single sided
    ...
    rapidity interval $2.0 < |y| < 2.2$ and was found to be 347 
    \textcolor{red}{$\pm X(stat) Y(syst)$ $\mu$$b$}.
  The cross section corrected for break-up mode is found to be 1.76 
    \textcolor{red}{$\pm X(stat) Y(syst)$ $mb$}, in agreement with theoretical 
    predictions and previous measurements by the ALICE collaboration.
